...
(	ID					  INT				PRIMARY KEY IDENTITY,
	...
	Justification		  VARCHAR(13)		NOT NULL,
...
CREATE TABLE Products --NEED HELP WITH KEYS
(	ID			 INT				PRIMARY KEY IDENTITY,
...
CREATE TABLE LineItems --REVIEW NEED HELP 
(	ID			 INT			PRIMARY KEY IDENTITY,
	RequestID	 INT 			NOT NULL,
	ProductID	 INT			NOT NULL,
	Quantity	 INT			NOT NULL,
	CONSTRAINT FK_LI  FOREIGN KEY(RequestID)
